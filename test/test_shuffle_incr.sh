#!/bin/bash
dir="/home/wq/golib/test/incr_shuffle/" # output directory
cpuUsage_values=("1")
...
type_name_values=("multiSegmentBest")
...
binlog_name_values=("/home/lluvia/go/src/github.com/go-mysql/binlog1-50.2txt")
    ...
    do
      ...
      do
          ...
          do
              ...
              # then
              buffer_size="${buffer_size_values[$j]}"
              # fi
              # balance="${pair[1]}"
